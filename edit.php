           ...
           <form class="form-horizontal" id="formKota" method="post">
             <div class="form-group">
               <label class="control-label col-md-4">Kode Kota:</label>
                 ...
                 <div class="input-group">
                   <input type="text" class="form-control" value="<?php echo $kodekota;?>" name="kodekota"placeholder="Kode Kota">
                 </div>
               </div>
             </div>
             ...
             <div class="form-group">
               <label class="control-label col-md-4">Kota :</label>
                 <div class="col-md-8">
                 <div class="input-group">
                   <input type="text" class="form-control has-error" value="<?php echo $kota;?>" name="kota" placeholder="Kota:">
                 </div>
               </div>
             </div>
